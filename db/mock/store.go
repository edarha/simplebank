...
// Source: github.com/edarha/simplebank/db/sqlc (interfaces: Store)
...
// UpdateOneAccount mocks base method.
func (m *MockStore) UpdateOneAccount(arg0 context.Context, arg1 db.UpdateOneAccountParams) (db.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateOneAccount", arg0, arg1)
	ret0, _ := ret[0].(db.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateOneAccount indicates an expected call of UpdateOneAccount.
func (mr *MockStoreMockRecorder) UpdateOneAccount(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateOneAccount", reflect.TypeOf((*MockStore)(nil).UpdateOneAccount), arg0, arg1)
}
